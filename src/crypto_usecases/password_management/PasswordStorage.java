...
public class PasswordStorage {
	...
	public static boolean storeSaltAndEncryptedPassword(byte[] encryptedPassword, byte[] salt) {
		System.out.println("Password = " + pwdMgmtUtils.returnStringRep(encryptedPassword) + " and corresponding salt = " + pwdMgmtUtils.returnStringRep(salt)
				+ " stored in credentials database ");
